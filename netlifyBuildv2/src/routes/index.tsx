...
import { LayoutGrid, List, Menu, Columns2, Columns3 } from 'lucide-react'
...
import { computeStats } from '@/components/StatsBar'
        ...
        <main className="flex-1 overflow-y-auto">
          ...
          <div className="sticky top-0 z-20 flex items-center gap-2 px-4 py-2 bg-gray-900/95 backdrop-blur border-b border-gray-800">
            ...
            <div className="hidden md:flex items-center gap-3 ml-3 text-xs text-gray-500">
              ...
              {totalScenes > 0 && <span>{totalScenes} scenes</span>}
              {avgScore > 0 && <span>avg {avgScore.toFixed(0)}</span>}
            </div>
